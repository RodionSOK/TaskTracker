...
from testApp.views import ForgotPasswordView, MyTokenObtainPairView, ResetPasswordView, TaskViewSet, CategoryViewSet, ProjectViewSet, RegisterView
...
urlpatterns = [
    ...
    path('api/v1/projects/', ProjectViewSet.as_view()),
    path('api/v1/projects/<int:pk>/', ProjectViewSet.as_view()),
